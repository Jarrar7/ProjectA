        ...
        <aside className="w-64 bg-indigo-600 text-white flex flex-col">
            ...
            <nav className="flex-1 mt-4">
                <ul>
                    ...
                    <li className={`hover:bg-indigo-500 p-4 flex items-center cursor-pointer ${activeSection === 'messages' ? 'bg-indigo-500' : ''}`}
                        onClick={() => setActiveSection('messages')}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="h-6 w-6 mr-4">
