...
const MessageListWithDetails = ({ messages, activeMessage, setActiveMessage, selectedSection }) => {
  ...
  return (
    <div className="flex-1 h-full p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md overflow-y-auto">
          ...
          {messages.map((message, index) => (
            <tr
              ...
              className={`${index % 2 === 0 ? "bg-gray-50 dark:bg-gray-800" : "bg-white dark:bg-gray-900"
                } hover:bg-blue-100 dark:hover:bg-gray-700 cursor-pointer transition-all duration-200 ease-in-out ${activeMessage?.id === message.id ? "bg-blue-50 dark:bg-gray-700" : ""
                }`}
      ...
      {activeMessage && (
        <div className="p-6 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-md mt-6">
          ...
          <div className="mt-4 text-gray-800 dark:text-gray-200">
            {activeMessage.content || "No Content Available"}
          </div>
        </div>
      )}
    </div>
