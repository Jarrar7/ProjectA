...
const SidebarAdmin = ({ activeSection, setActiveSection, logout }) => {
    return (
        ...
        <nav className="flex-1 mt-4">
            <ul>
                <li className={`hover:bg-indigo-500 p-4 flex items-center cursor-pointer ${activeSection === 'manageUsers' ? 'bg-indigo-500' : ''}`}
                ...
                <li className={`hover:bg-indigo-500 p-4 flex items-center cursor-pointer ${activeSection === 'manageCourses' ? 'bg-indigo-500' : ''}`}
