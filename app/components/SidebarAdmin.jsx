...
import { FaBars, FaTimes, FaUsers, FaBook, FaSignOutAlt } from "react-icons/fa";
        ...
        <>
            ...
            >
                ...
                <nav className="flex-1 mt-4">
                    <ul>
                        {[
                            { section: "manageUsers", label: "Manage Users", icon: <FaUsers className="mr-4" /> },
                            { section: "manageCourses", label: "Manage Courses", icon: <FaBook className="mr-4" /> },
